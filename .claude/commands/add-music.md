...
- Strip trailing suffixes matching any of `(Official Music Video)`, `[Official Music Video]`, `(Official Video)`, `[Official Video]`, `(Video)`, `[Video]`, `(Music Video)`, `[Music Video]`, `(Official Audio)`, `(Audio)`, `(Lyrics)`, `(HD)`, `(4K)`, `(Official HD Video)`, `(Official 4K Video)`, `(Official 4K Music Video)`, `(Remastered)`, `(Live)`, or a bare `(YYYY)`. The intent is to strip **video-quality / video-role metadata** — bracket vs paren, "HD" vs "4K", "Video" vs "Music Video" are all the same category; apply the same-intent extension when a novel variant appears.
