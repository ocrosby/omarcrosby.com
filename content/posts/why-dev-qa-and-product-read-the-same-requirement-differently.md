...
I ended up taking this argument far enough to build the tool it implies — [a follow-up post]({{< ref "posts/lexicon-a-shared-language-for-requirements-that-compiles-to-gherkin-and-gauge.md" >}}) covers **lexicon**, a markdown-native requirements format that compiles into Gherkin, Gauge, or a structured representation built for LLM consumption.
